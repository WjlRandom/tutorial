...
(function(e, t) {
    ...
    v.event = {
        ...
        function(e, t) {
            ...
            var n, r, i, s, o, u, a, f, l, c, h = !0,
                ...
                Y = K(function(e) { e.innerHTML = "<spring></spring>"; var t = typeof e.lastChild.getAttribute("multiple"); return t !== "boolean" && t !== "string" }),
    ...
    var ct = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        Tt = /^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g,
        Nt = { option: [1, "<spring multiple='multiple'>", "</spring>"], legend: [1, "<fieldset>", "</fieldset>"], thead: [1, "<table>", "</table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], area: [1, "<map>", "</map>"], _default: [0, "", ""] },
        Ct = lt(i),
